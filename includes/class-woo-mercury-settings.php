...
class Woo_Mercury_Settings {

	/**
	 * The single instance of Woo_Mercury_Settings.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function add_settings_link ( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'woo-mercury' ) . '</a>';
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'woo-mercury' ) ) . '" />' . "\n";
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
		$html .= '</div>' . "\n";
	...
	/**
	 * Main Woo_Mercury_Settings Instance
	 *
	 * Ensures only one instance of Woo_Mercury_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Woo_Mercury()
	 * @return Main Woo_Mercury_Settings instance
	 */
